...
export const navigationTree: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: 'primitives',
        label: 'Primitives', // Renamed from foundations, placed first for logical flow
        section: 'motion',
      },
      {
        id: 'text-effects',
      ...
      {
        id: 'backgrounds', // New section for Galaxy, Faulty Terminal
        label: 'Backgrounds',
        section: 'motion',
      },
      {
        id: 'cursors', // New section for Target, Splash
        label: 'Cursors',
        section: 'motion',
      },
      {
        id: 'micro-interactions', // Promoted from "interactive"
